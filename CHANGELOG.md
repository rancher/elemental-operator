...
#### [v0.6.3](https://github.com/rancher/elemental-operator/compare/v0.6.2...v0.6.3)

> 20 October 2022

- operator: unit-tests: add coverage for unauthenticatedResponse() [`#217`](https://github.com/rancher/elemental-operator/pull/217)
- coverity: make patch status informational [`#219`](https://github.com/rancher/elemental-operator/pull/219)
- tests: Add k8s 1.24 and default to rancher 2.6.9 [`#220`](https://github.com/rancher/elemental-operator/pull/220)
- tests: use latest url for rancher charts [`#218`](https://github.com/rancher/elemental-operator/pull/218)
- operator: create ServiceAccounts before their Secrets [`#197`](https://github.com/rancher/elemental-operator/issues/197)
- operator: move ServiceAccount creation to a separate func [`27b3359`](https://github.com/rancher/elemental-operator/commit/27b33591224bab9194196f225b15ceef3d57cd3c)
- operator: improve logging of the MachineRegistration controller [`0c64b49`](https://github.com/rancher/elemental-operator/commit/0c64b49a1ce7675bd475cfb6810bb1e3a7ea00d5)
- operator: enforce ServiceAccount's Secret link [`05800af`](https://github.com/rancher/elemental-operator/commit/05800af13409d73d2c9c04ab4f03706eb9e64b7f)

#### [v0.6.2](https://github.com/rancher/elemental-operator/compare/v0.6.1...v0.6.2)

> 18 October 2022

- Elemental Operator: manage empty config in MachineRegistrations [`#213`](https://github.com/rancher/elemental-operator/pull/213)
- Label other objects created by elemental-operator [`#216`](https://github.com/rancher/elemental-operator/pull/216)
- Only read yaml files included in the given directories [`#215`](https://github.com/rancher/elemental-operator/pull/215)
- Label secrets managed by elemental-operator [`#212`](https://github.com/rancher/elemental-operator/pull/212)
- Allow custom config files for elemental-cli [`#210`](https://github.com/rancher/elemental-operator/pull/210)
- Collect operator logs after running tests [`#204`](https://github.com/rancher/elemental-operator/pull/204)
- Audit and update elemental-operator RBAC ClusterRole [`#196`](https://github.com/rancher/elemental-operator/pull/196)
- Add config for e2e tests [`#201`](https://github.com/rancher/elemental-operator/pull/201)
- Elemental Operator: manage empty config in MachineRegistrations (#213) [`#202`](https://github.com/rancher/elemental-operator/issues/202)
- Label other objects created by elemental-operator (#216) [`#435`](https://github.com/rancher/elemental/issues/435)
- Label secrets managed by elemental-operator (#212) [`#396`](https://github.com/rancher/elemental/issues/396)

#### [v0.6.1](https://github.com/rancher/elemental-operator/compare/v0.6.0...v0.6.1)

> 10 October 2022

- Add OBS workflow to update elemental-operator package [`#200`](https://github.com/rancher/elemental-operator/pull/200)
- Add vendor for obs integration [`#198`](https://github.com/rancher/elemental-operator/pull/198)
- release: enhance release pipeline [`#195`](https://github.com/rancher/elemental-operator/pull/195)
- operator: drop duplicated import of elemental APIs [`#199`](https://github.com/rancher/elemental-operator/pull/199)
- Disable CGO under arm for register binaries + restore SBOM [`#193`](https://github.com/rancher/elemental-operator/pull/193)
- Revert "Add sbom to releases and attach to containers" [`#191`](https://github.com/rancher/elemental-operator/pull/191)
- Add elemental GlobalRole for Rancher UI [`#187`](https://github.com/rancher/elemental-operator/pull/187)
- Add reasons for conditions [`#185`](https://github.com/rancher/elemental-operator/pull/185)
- lint: dont overshadow var [`#172`](https://github.com/rancher/elemental-operator/pull/172)
- Add v0.6.0 changelog [`#182`](https://github.com/rancher/elemental-operator/pull/182)
- Add elemental GlobalRole for Rancher UI (#187) [`#332`](https://github.com/rancher/elemental/issues/332)
