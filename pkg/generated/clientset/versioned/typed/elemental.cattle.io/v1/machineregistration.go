...
func newMachineRegistrations(c *RancherosV1Client, namespace string) *machineRegistrations {
...
func (c *machineRegistrations) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.MachineRegistration, err error) {
...
func (c *machineRegistrations) List(ctx context.Context, opts metav1.ListOptions) (result *v1.MachineRegistrationList, err error) {
...
func (c *machineRegistrations) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineRegistrations) Create(ctx context.Context, machineRegistration *v1.MachineRegistration, opts metav1.CreateOptions) (result *v1.MachineRegistration, err error) {
	result = &v1.MachineRegistration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machineregistrations").
...
func (c *machineRegistrations) Update(ctx context.Context, machineRegistration *v1.MachineRegistration, opts metav1.UpdateOptions) (result *v1.MachineRegistration, err error) {
	result = &v1.MachineRegistration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineregistrations").
...
func (c *machineRegistrations) UpdateStatus(ctx context.Context, machineRegistration *v1.MachineRegistration, opts metav1.UpdateOptions) (result *v1.MachineRegistration, err error) {
	result = &v1.MachineRegistration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineregistrations").
...
func (c *machineRegistrations) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *machineRegistrations) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *machineRegistrations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.MachineRegistration, err error) {
	result = &v1.MachineRegistration{}
