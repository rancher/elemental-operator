...
func newManagedOSVersionChannels(c *RancherosV1Client, namespace string) *managedOSVersionChannels {
...
func (c *managedOSVersionChannels) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ManagedOSVersionChannel, err error) {
...
func (c *managedOSVersionChannels) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ManagedOSVersionChannelList, err error) {
...
func (c *managedOSVersionChannels) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedOSVersionChannels) Create(ctx context.Context, managedOSVersionChannel *v1.ManagedOSVersionChannel, opts metav1.CreateOptions) (result *v1.ManagedOSVersionChannel, err error) {
	result = &v1.ManagedOSVersionChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedosversionchannels").
...
func (c *managedOSVersionChannels) Update(ctx context.Context, managedOSVersionChannel *v1.ManagedOSVersionChannel, opts metav1.UpdateOptions) (result *v1.ManagedOSVersionChannel, err error) {
	result = &v1.ManagedOSVersionChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedosversionchannels").
...
func (c *managedOSVersionChannels) UpdateStatus(ctx context.Context, managedOSVersionChannel *v1.ManagedOSVersionChannel, opts metav1.UpdateOptions) (result *v1.ManagedOSVersionChannel, err error) {
	result = &v1.ManagedOSVersionChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedosversionchannels").
...
func (c *managedOSVersionChannels) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *managedOSVersionChannels) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedOSVersionChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ManagedOSVersionChannel, err error) {
	result = &v1.ManagedOSVersionChannel{}
