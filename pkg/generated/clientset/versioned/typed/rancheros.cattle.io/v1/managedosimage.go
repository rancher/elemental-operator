...
func newManagedOSImages(c *RancherosV1Client, namespace string) *managedOSImages {
...
func (c *managedOSImages) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ManagedOSImage, err error) {
...
func (c *managedOSImages) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ManagedOSImageList, err error) {
...
func (c *managedOSImages) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedOSImages) Create(ctx context.Context, managedOSImage *v1.ManagedOSImage, opts metav1.CreateOptions) (result *v1.ManagedOSImage, err error) {
	result = &v1.ManagedOSImage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedosimages").
...
func (c *managedOSImages) Update(ctx context.Context, managedOSImage *v1.ManagedOSImage, opts metav1.UpdateOptions) (result *v1.ManagedOSImage, err error) {
	result = &v1.ManagedOSImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedosimages").
...
func (c *managedOSImages) UpdateStatus(ctx context.Context, managedOSImage *v1.ManagedOSImage, opts metav1.UpdateOptions) (result *v1.ManagedOSImage, err error) {
	result = &v1.ManagedOSImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedosimages").
...
func (c *managedOSImages) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *managedOSImages) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedOSImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ManagedOSImage, err error) {
	result = &v1.ManagedOSImage{}
