...
//
//	mockgen-v0.6.0 -copyright_file=scripts/boilerplate.go.txt -destination=pkg/network/mocks/network.go -package=mocks github.com/rancher/elemental-operator/pkg/network Configurator
//
...
func (m *MockConfigurator) GetNetworkConfigApplicator(networkConfig v1beta1.NetworkConfig) (schema.YipConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNetworkConfigApplicator", networkConfig)
...
func (mr *MockConfiguratorMockRecorder) GetNetworkConfigApplicator(networkConfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNetworkConfigApplicator", reflect.TypeOf((*MockConfigurator)(nil).GetNetworkConfigApplicator), networkConfig)
}
