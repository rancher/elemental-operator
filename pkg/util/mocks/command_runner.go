...
//
//	mockgen-v0.6.0 -copyright_file=scripts/boilerplate.go.txt -destination=pkg/util/mocks/command_runner.go -package=mocks github.com/rancher/elemental-operator/pkg/util CommandRunner
//
...
func (mr *MockCommandRunnerMockRecorder) Run(name any, arg ...any) *gomock.Call {
