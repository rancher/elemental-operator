...
//
//	mockgen-v0.6.0 -copyright_file=scripts/boilerplate.go.txt -destination=pkg/util/mocks/net_controller.go -package=mocks github.com/rancher/elemental-operator/pkg/util NetController
//
...
func (m *MockNetController) GetInterfaceAddresses(ifName string) []net.IPNet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetInterfaceAddresses", ifName)
	ret0, _ := ret[0].([]net.IPNet)
	return ret0
}

// GetInterfaceAddresses indicates an expected call of GetInterfaceAddresses.
func (mr *MockNetControllerMockRecorder) GetInterfaceAddresses(ifName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInterfaceAddresses", reflect.TypeOf((*MockNetController)(nil).GetInterfaceAddresses), ifName)
}
